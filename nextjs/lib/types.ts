...
export type ThemeBackground = {
    // Defines how the background is rendered: solid color, CSS gradient, or image
    type?: 'color' | 'gradient' | 'image' | 'none'; 
    // The value for the background (e.g., #FFFFFF, linear-gradient(...), or URL)
    value?: string | null;
}
...
export type StorefrontTheme = {
    ...
    // --- ADDED: Custom Background Settings ---
    background?: ThemeBackground;
};

// ===== Storefront config =====
export type StorefrontDisplayMode = "grid" | "list" | "links" |"grid_1"|"grid_2"|"grid_3";
